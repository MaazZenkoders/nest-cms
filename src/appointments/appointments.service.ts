...
export class AppointmentsService {
  ...
  async createAppointment(createappointmentdto: CreateAppointmentDto) {
    ...
    await this.emailService.sendAppointmentEmail(student.email, {student:student.name, teacher:teacher.name, start_time:appointment.start_time, end_time: appointment.end_time} )
    return {
  ...
  async approveRejectAppointment(id: number, approverejectappointmentdto: ApproveRejectAppointmentDto) {
    const teacher = await this.teacherRepository.findOne({
